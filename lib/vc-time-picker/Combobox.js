...
var Combobox = {
  ...
  render: function render() {
    ...
    if (format) {
      ...
      var elemsOrder = [];
      while (char) {
        if (formatAllowedChars.includes(char) && !_elems.includes(char)) {
          _elems.push(char);
        }
        char = char[++idx];
      }
      ...
      if (_elems.length > 0) {
        ...
        _elems.push(bindMap['h']());
        _elems.push(bindMap['m']());
        _elems.push(bindMap['s']());
        _elems.push(bindMap['a']());
      }
    }
